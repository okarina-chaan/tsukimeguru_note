...
自分のスケジュール帳を見返すと、TODOタスクばかり書かれていませんか？  
このアプリを使うことで、  
> 「自分はどうなりたい？そのために何をする？」
...
#### 月相との連動
単なる日記アプリではなく、月のリズムと体調や感情の変化を結びつける独自性  

#### 共有機能がない日記アプリ
共有機能をあえてなくすことで、ありのままを記録することができる  

#### Moon Note
新月・上弦の月・満月・下弦の月のタイミングで記録できる特別な日記。ぴったりの月齢にすると記録可能の判定がシビアになるため、ゆとりをもたせるようにしました。  

#### AIによる振り返り機能
先週分のDaily Noteをまとめて要約し、ユーザーに気付きを与えてくれるような問いを返す、その点で留まってくれるように設計しました。  
AIによって評価される機能にはしたくなかったからです。  
ユーザーが主体的に日々を振り返ることができるように手伝う機能として作りました。  
...
[![Image from Gyazo](https://i.gyazo.com/7628da55ccc00f31a4201ed26085c128.png)](https://gyazo.com/7628da55ccc00f31a4201ed26085c128)
